...
public class ProtectionRemoveHandler extends RegionHandler implements CancelableHandler {
    @Getter
    ...
    public ProtectionRemoveHandler(ProtectionRegion region, CommandExecutor executor) {
        super(region);
