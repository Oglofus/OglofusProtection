...
public class PlayerPromoteHandler extends RegionHandler implements CancelableHandler {
    @Getter
    ...
    public PlayerPromoteHandler(ProtectionRegion region, User user, CommandExecutor executor) {
        super(region);
        this.user = user;
