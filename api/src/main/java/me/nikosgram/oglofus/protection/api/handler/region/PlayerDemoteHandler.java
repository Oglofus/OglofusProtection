...
public class PlayerDemoteHandler extends RegionHandler implements CancelableHandler {
    @Getter
    ...
    public PlayerDemoteHandler(ProtectionRegion region, User user, CommandExecutor executor) {
        super(region);
        this.user = user;
